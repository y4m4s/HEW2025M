      ...
      {editOpen && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
          <div className="bg-white rounded-xl p-6 w-full max-w-md relative">
            ...
            <button
              onClick={() => setEditOpen(false)}
              className="mt-5 w-full bg-[#2FA3E3] text-white py-2 rounded-lg"
            >
              保存
            </button>
          </div>
          ...
          <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div>
              <div className="bg-white rounded-xl shadow-lg p-6 mb-6 text-center">
                ...
                <button
                  className="w-full bg-[#2FA3E3] text-white py-3 rounded-lg mb-3 hover:bg-[#1d7bb8]"
                  onClick={() => setEditOpen(true)}
                >
                  プロフィール編集
                </button>
                <button className="w-full border border-[#2FA3E3] text-[#2FA3E3] py-3 rounded-lg hover:bg-[#2FA3E3] hover:text-white">
                  メッセージ
                </button>
              </div>
              ...
              <div className="bg-white rounded-xl shadow-lg p-6">
                ...
                <p className="text-sm text-gray-600">
                  釣り歴15年。ルアーフィッシングが好きで、使わない釣り具を出品中です。
                </p>
              </div>
            </div>
